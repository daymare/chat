...
tf.app.flags.DEFINE_list('persona_encoder_sizes', '400, 400, 300',
        'size of each layer in the persona encoder')
tf.app.flags.DEFINE_list('decoder_sizes', '500, 500, 500',
...
tf.app.flags.DEFINE_float('learning_rate',
        6*10**-4, 'learning rate during training')
...
tf.app.flags.DEFINE_string('logdir',
        './train/progressive_overfit/2048', 'where to save tensorboard summaries')
