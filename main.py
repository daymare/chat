...
# model flags
tf.app.flags.DEFINE_list('encoder_sizes', '300, 300, 300',
...
tf.app.flags.DEFINE_list('persona_encoder_sizes', '300, 300',
        'size of each layer in the persona encoder')
tf.app.flags.DEFINE_list('decoder_sizes', '300, 300, 300',
...
tf.app.flags.DEFINE_string('logdir',
        './train/progressive_overfit/512', 'where to save tensorboard summaries')
tf.app.flags.DEFINE_integer('dataset_size', 512, 
